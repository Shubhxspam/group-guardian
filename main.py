...
async def start(bot, update):
    await update.reply("""Hi there! I'm the Telegram  ❥⍣⃝𝐍ᴀᴠʏᴀⓍ≛⃝ 𝐃ᴇᴍᴏɴ🦋⃟❱‌ٖ bot. I'm here to help you keep your group clean and safe for everyone. Here are the main features I offer:
...
Thanks for using Telegram Group Guardian! Let's keep your group safe and respectful. Powered by [sʜᴜʙʜ] @Mrpasserby_1227""")
